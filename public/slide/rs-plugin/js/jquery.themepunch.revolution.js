...
(function($, undefined) {
      ...
      return this.each(function() {
        ...
        if (!container.hasClass('revslider-initialised')) {
          ...
          if (opt.shuffle == 'on') {
            for (var u = 0; u < container.find('>ul:first-child >li').length; u++) {
              ...
              container
                ...
                .prependTo(container.find('>ul:first-child'));
            }
          }
          ...
          if (opt.shadow != 0) {
            container
              .parent()
              .append('<div class="tp-bannershadow tp-shadow' + opt.shadow + '"></div>');
  ...
  function moveThumbSliderToPosition($this, pos, speed) {
    ...
    $this
      ...
      .animate({ left: pos + 'px' }, { duration: speed, queue: false });
  }
  ...
  function createBullets(container, opt) {
    if (opt.navigationType == 'bullet' || opt.navigationType == 'both') {
      container
        .parent()
        .append('<div class="tp-bullets simplebullets ' + opt.navigationStyle + '"></div>');
    }
  ...
  function createArrows(container, opt) {
    ...
    container
      .parent()
      .append('<div style="' + hidden + '" class="tp-leftarrow tparrows ' + arst + '"></div>');
    container
      .parent()
      .append('<div style="' + hidden + '" class="tp-rightarrow tparrows ' + arst + '"></div>');
  ...
  function swapSlide(container, opt) {
    ...
    else if (nextli.data('transition') == 'cubic' || nextli.data('transition') == 'cube')
      nexttrans = 19;
    ...
    var masterspeed = 300;
    if (
      nextli.data('masterspeed') != undefined &&
      nextli.data('masterspeed') > 99 &&
      nextli.data('masterspeed') < 4001
    )
    ...
    if (nexttrans == 12 || nexttrans == 13 || nexttrans == 14 || nexttrans == 15) {
      ...
      if (nexttrans == 12)
        ...
        if (opt.ie9) ssn.transition({ left: 0 - opt.width + 'px' }, 0);
        else ssn.transition({ left: 0 - opt.width + 'px', rotate: opt.rotate }, 0);
      else if (nexttrans == 13)
        if (opt.ie9) ssn.transition({ top: ooh + 'px' }, 0);
        else ssn.transition({ top: ooh + 'px', rotate: opt.rotate }, 0);
    ...
    if (nexttrans == 16) {
      ...
      if (!$.support.transition) {
        actli
          .find('.tp-half-one')
          .animate({ opacity: 0, top: 0 - opt.height / 2 + 'px' }, { duration: 500, queue: false });
        actli
          .find('.tp-half-two')
          .animate({ opacity: 0, top: opt.height + 'px' }, { duration: 500, queue: false });
      } else {
        ...
        if (actli.html() != null)
          nextli
            .transition({ scale: 0.8, x: opt.width * 0.1, y: opt.height * 0.1, rotate: ro1 }, 0)
  ...
  function endMoveCaption(nextcaption, opt) {
    ...
    if (
      ...
      if (nextcaption.hasClass('ltr')) xx = opt.width + 60;
      else if (nextcaption.hasClass('ltl')) xx = 0 - nextcaption.width() - 60;
      else if (nextcaption.hasClass('ltt')) yy = 0 - nextcaption.height() - 60;
      else if (nextcaption.hasClass('ltb')) yy = opt.height + 60;
      ...
      nextcaption.animate(
        { opacity: oo, left: xx + 'px', top: yy + 'px' },
        {
      ...
      if (nextcaption.hasClass('lfr')) xx = opt.width + 60;
      else if (nextcaption.hasClass('lfl')) xx = 0 - nextcaption.width() - 60;
      else if (nextcaption.hasClass('lft')) yy = 0 - nextcaption.height() - 60;
      else if (nextcaption.hasClass('lfb')) yy = opt.height + 60;
