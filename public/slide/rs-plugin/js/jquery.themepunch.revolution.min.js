...
(function (e, t) {
  ...
  function E(n, r) {
    ...
    if (r.ie) {
      ...
      if (o.data('transition') == 'slotfade-horizontal')
        o.data('transition', 'slotzoom-horizontal');
    }
    if (o.data('delay') != t) {
      r.cd = 0;
    ...
    if (l == 11) {
      ...
      f.find('.slotslide').each(function (t) {
        ...
        setTimeout(function () {
          if (r.ie9 || r.ie) {
            if (r.ie) o.animate({ opacity: 1 }, { duration: h });
            else n.transition({ opacity: 1 }, h);
          } else {
    ...
    if (l == 12 || l == 13 || l == 14 || l == 15) {
      ...
      if (l == 12)
        ...
        if (r.ie9) w.transition({ top: v + 'px' }, 0);
        else w.transition({ top: v + 'px', rotate: r.rotate }, 0);
      else if (l == 14)
      ...
      if (l == 12) E.transition({ left: 0 - d + 'px', opacity: 1, rotate: 0 }, h);
      else if (l == 15) E.transition({ left: d + 'px', opacity: 1, rotate: 0 }, h);
      else if (l == 13) E.transition({ top: 0 - v + 'px', opacity: 1, rotate: 0 }, h);
      else if (l == 14) E.transition({ top: v + 'px', opacity: 1, rotate: 0 }, h);
    }
    if (l == 16) {
      ...
      if (!e.support.transition) {
        ...
        i.find('.tp-half-one').transition(
          { opacity: 1, scale: k, rotate: N, y: 0 - r.height / 1.4 + 'px' },
          800,
          'in'
        );
    ...
    if (l == 19) {
      ...
      f.find('.slotslide').each(function (t) {
        ...
        if (c == 1)
          ...
          s.transition(
            { opacity: 0, left: 0, top: 0 - r.height / 2, rotate3d: '1, 0, 0, 90deg ' },
            0
          );
        setTimeout(function () {
          s.transition(
            { opacity: 1, top: 0, perspective: r.height * 2, rotate3d: ' 1, 0, 0, 0deg ' },
            h * 2,
            function () {
              if (t == r.slots - 1) {
                b(n, r);
    ...
    if (l == 20) {
      ...
      f.find('.slotslide').each(function (t) {
        ...
        s.parent().css({ overflow: 'visible' });
        if (c == 1)
          s.transition({ scale: 0.8, top: 0, left: 0 - r.width, rotate3d: '2, 5, 0, 110deg' }, 0);
        else
          s.transition({ scale: 0.8, top: 0, left: 0 + r.width, rotate3d: '2, 5, 0, -110deg' }, 0);
        setTimeout(function () {
          s.transition(
            { scale: 0.8, left: 0, perspective: r.width, rotate3d: '1, 5, 0, 0deg' },
            h * 2,
            'ease'
    ...
    if (l == 21) {
      ...
      f.find('.slotslide').each(function (t) {
        var s = e(this);
        if (c == 1) s.transition({ top: 0, left: 0 - r.width, rotate3d: '0, 1, 0, 90deg' }, 0);
      ...
      a.find('.slotslide').each(function (t) {
        ...
        setTimeout(function () {
          if (c == 1)
            n.transition(
              { top: 0, left: r.width / 2, perspective: r.width, rotate3d: '0, 1, 0, -90deg' },
              h * 1.5,
              function () {}
            );
          else
            n.transition(
              { top: 0, left: 0 - r.width / 2, perspective: r.width, rotate3d: '0, 1, 0, +90deg' },
              h * 1.5,
              function () {}
            );
        }, t * 100);
  ...
  function L(n, r, i) {
    ...
    n.find('.tp-caption').each(function (i) {
      ...
      if (f == 0) {
              ...
              if (!n.hasClass('HasListener')) {
                try {
                  ...
                  if (a.data('autoplay') == true)
                    r = new YT.Player(c, { events: { onStateChange: x, onReady: T } });
        ...
        if (a.hasClass('randomrotate') && (r.ie || r.ie9))
          a.removeClass('randomrotate').addClass('sfb');
        ...
        a.data(
          ...
          setTimeout(function () {
            ...
            if (
              ...
              a.data('repo', a.css('opacity'));
              a.animate(
                { opacity: 1, left: o * a.data('x') + s + 'px', top: r.bh * a.data('y') + 'px' },
                {
                  duration: a.data('speed'),
                  easing: n,
                  complete: function () {
        ...
        if (a.data('end') != t)
          a.data(
            ...
            setTimeout(function () {
              if (
                (r.ie || r.ie9) &&
                (a.hasClass('randomrotate') || a.hasClass('randomrotateout'))
              ) {
