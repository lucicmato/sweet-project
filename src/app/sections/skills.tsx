        ...
        <div className="grid_5">
          ...
          <div className="skilldescription">
            ...
            <p>
              ...
              sastojci i izgled koji mami osmijeh. Bilo da se radi o klasičnim receptima ili
              modernim kombinacijama, svaki kolač izrađen je s puno pažnje i ljubavi.
            </p>
          </div>
          {/*skill*/}
          ...
          <div className="skilldescription">
            ...
            <p>
              Naše torte su prava mala remek-djela – vizualno očaravaju, a okusom obaraju s nogu.
              Svaki sloj pažljivo je osmišljen da spoji bogate kreme, sočne biskvite i neodoljive
              detalje u tortu koja se pamti.
            </p>{' '}
            {/*you can edit*/}
          </div>
          {/*skill*/}
          ...
          <div className="skilldescription">
            ...
            <p>
              Naše princez krafne su apsolutno neodoljive – lagano, prozračno tijesto i bogata,
              kremasta punjenja stvaraju savršen spoj okusa. Ručno rađene s puno pažnje, postale su
              naš prepoznatljiv desert koji svi obožavaju.
            </p>{' '}
            {/*you can edit*/}
          </div>
          {/*skill*/}
